...
class Peer:
    def __init__(self, is_server, host="165.1.220.194", port=8080):
    ...
    def start_client(self):
        ...
        try:
            print(f"Tentando conectar ao servidor em {self.host}:{self.port}...")
            ...
            print("Certifique-se de que o servidor está rodando e acessível na rede.")
            return
...
if __name__ == "__main__":
    ...
    is_server = mode == "s"
    # Substitua 'localhost' pelo IP do servidor no caso de máquinas diferentes
    host = input("Digite o endereço IP do servidor (ou pressione Enter para localhost): ") or "localhost"
    peer = Peer(is_server, host=host)
    peer.start()
